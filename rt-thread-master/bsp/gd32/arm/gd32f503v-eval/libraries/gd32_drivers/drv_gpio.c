...
static void gd32_pin_mode(rt_device_t dev, rt_base_t pin, rt_uint8_t mode)
{
...
#if defined (SOC_SERIES_GD32F4xx) || defined (SOC_SERIES_GD32H7xx) || defined (SOC_SERIES_GD32F5xx) || defined (SOC_SERIES_GD32F50x) || defined (SOC_SERIES_GD32E23x) || defined (SOC_SERIES_GD32G5x3)
    ...
    if(pin_mode == GPIO_MODE_OUTPUT)
    {
        gpio_output_options_set(index->gpio_periph, pin_odpp, GPIO_OSPEED_LEVEL2, index->pin);
    }
