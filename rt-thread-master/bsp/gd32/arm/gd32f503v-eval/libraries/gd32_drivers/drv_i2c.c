...
#if !defined(BSP_USING_I2C0) && !defined(BSP_USING_I2C1) && !defined(BSP_USING_I2C2) && !defined(BSP_USING_I2C3)  && !defined(BSP_USING_I2C4)  && !defined(BSP_USING_I2C5)
...
#if defined (SOC_SERIES_GD32F5xx) || defined (SOC_SERIES_GD32F50x)
...
static const struct gd32_i2c_bus gd_i2c_config[] = {
...
#ifdef BSP_USING_I2C1
    {
		...
		RCU_I2C1, RCU_GPIOF, RCU_GPIOA,       // periph clock, scl gpio clock, sda gpio clock

        GPIOF, GPIO_AF_4, GPIO_PIN_6,          // scl port, scl alternate, scl pin
        GPIOA, GPIO_AF_4, GPIO_PIN_8,          // sda port, sda alternate, sda pin
#elif defined (SOC_SERIES_GD32F30x) ||defined (SOC_SERIES_GD32C11x)
...
#if defined (SOC_SERIES_GD32G5x3)  
			  RCU_I2C2, RCU_GPIOG, RCU_GPIOG,       // periph clock, scl gpio clock, sda gpio clock

        GPIOG, GPIO_AF_4, GPIO_PIN_7,          // scl port, scl alternate, scl pin
        GPIOG, GPIO_AF_4, GPIO_PIN_8,          // sda port, sda alternate, sda pin
#else
...
#endif
        {
#if defined (SOC_SERIES_GD32F5xx) || defined (SOC_SERIES_GD32H7xx) || defined (SOC_SERIES_GD32G5x3) 
