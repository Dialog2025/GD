...
#if defined SOC_SERIES_GD32F4xx || defined SOC_SERIES_GD32F5xx || defined SOC_SERIES_GD32F50x || defined SOC_SERIES_GD32H7xx || defined SOC_SERIES_GD32G5x3
...
#if defined SOC_SERIES_GD32F4xx || defined SOC_SERIES_GD32H7xx || defined SOC_SERIES_GD32F5xx || defined SOC_SERIES_GD32F50x || defined SOC_SERIES_GD32G5x3
        RCU_GPIOA, RCU_GPIOA,                   /* tx gpio clock, rx gpio clock */
...
#if defined SOC_SERIES_GD32F4xx || defined SOC_SERIES_GD32H7xx || defined SOC_SERIES_GD32F5xx || defined SOC_SERIES_GD32G5x3
...
void gd32_uart_gpio_init(struct gd32_uart *uart)
{
...
#if defined SOC_SERIES_GD32F4xx || defined SOC_SERIES_GD32F5xx || defined SOC_SERIES_GD32F50x || defined SOC_SERIES_GD32E23x
    ...
    gpio_output_options_set(uart->tx_port, GPIO_OTYPE_PP, GPIO_OSPEED_LEVEL3, uart->tx_pin);

    /* configure USART Rx as alternate function push-pull */
    gpio_mode_set(uart->rx_port, GPIO_MODE_AF, GPIO_PUPD_PULLUP, uart->rx_pin);
    gpio_output_options_set(uart->rx_port, GPIO_OTYPE_PP, GPIO_OSPEED_LEVEL3, uart->rx_pin);
